package io.realworld.android.emojify;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String FILE_PROVIDER_AUTHORITY = "io.realworld.android.fileprovider";

    private ImageView mImageView;

    private FloatingActionButton mEmojifyButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmojifyButton = (FloatingActionButton) findViewById(R.id.emojify_button);
